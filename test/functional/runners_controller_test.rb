...
class RunnersControllerTest < ActionController::TestCase
  ...
  test "should create runner" do
    assert_difference('Runner.count') do
      post :create, runner: { background: @runner.background, message_id: @runner.message_id, poster_id: @runner.poster_id, skills: @runner.skills, task_id: @runner.task_id }
    end
  ...
  test "should update runner" do
    put :update, id: @runner, runner: { background: @runner.background, message_id: @runner.message_id, poster_id: @runner.poster_id, skills: @runner.skills, task_id: @runner.task_id }
    assert_redirected_to runner_path(assigns(:runner))
  end
